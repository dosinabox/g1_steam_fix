...
- Thorus can no longer be bribed if the player has already obtained the permit to an audience with Gomez (Dimus); Corrected the bug when the option to bribe Thorus stays open even after the player already bribed him;
